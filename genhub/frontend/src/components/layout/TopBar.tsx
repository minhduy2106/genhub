...
export function TopBar() {
  ...
  return (
    <header className="h-14 border-b border-gray-200/80 bg-white/80 backdrop-blur-md flex items-center justify-between px-4 lg:px-6 shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative pl-3 border-l border-gray-200" ref={dropdownRef}>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl shadow-xl shadow-gray-900/10 border border-gray-100 py-1.5 z-50">
